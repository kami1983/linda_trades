...
# 控制分页抓取
DAILY_OHLCV_LIMIT_PER_CALL=200      # 每次请求的条数（多数交易所限制为 100 或 200）
DAILY_OHLCV_MAX_PAGES=10000         # 最大翻页数，防止极端情况死循环
DAILY_OHLCV_FORCE_FULL=0            # 1=忽略断点续跑，从 LOOKBACK 起全量回补
